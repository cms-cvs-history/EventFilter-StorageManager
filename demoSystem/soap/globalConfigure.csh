...
echo ""
echo "========================================"
echo "Configuring the event processor (2)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Configuring the event processor (3)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Configuring the event processor (4)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Configuring the event processor (5)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Configuring the event processor (6)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Configuring the event processor (7)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Configuring the event processor (8)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
