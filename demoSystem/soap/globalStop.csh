...
rm -f tmp.xml
cat tmp2.xml | sed "s,REQUESTED_ACTION,Stop," > tmp.xml
...
# the following sleep needs to be short (17-Apr-2008, KAB)
sleep 1

echo ""
echo "========================================"
echo "Stopping the event processor..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Stopping the event processor (2)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Stopping the event processor (3)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Stopping the event processor (4)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Stopping the event processor (5)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Stopping the event processor (6)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Stopping the event processor (7)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo ""
echo "========================================"
echo "Stopping the event processor (8)..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
...
echo "========================================"
echo "Stopping the storage manager..."
echo "========================================"
rm -f tmp.xml
rm -f tmp2.xml
