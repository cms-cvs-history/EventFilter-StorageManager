// $Id: FragmentMonitorCollection.cc,v 1.1.2.13 2009/02/16 13:39:52 mommsen Exp $
...
void FragmentMonitorCollection::do_addDOMElement(XHTMLMaker& maker, XHTMLMaker::Node *parent) const
{
