// $Id: StatisticsReporter.h,v 1.13.8.1 2011/01/24 12:18:39 mommsen Exp $
...
namespace stor {
  ...
  public:
     ...
     */
    AlarmHandlerPtr alarmHandler() { return alarmHandler_; }
  ...
  private:
    ...
    utils::time_point_t lastMonitorAction_;
