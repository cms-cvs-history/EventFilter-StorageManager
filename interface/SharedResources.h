// $Id: SharedResources.h,v 1.1.2.17 2009/04/10 11:27:01 dshpakov Exp $
...
namespace stor {
  ...
  struct SharedResources
  {
    ...
    boost::shared_ptr<EventQueueCollection> _dqmEventConsumerQueueCollection;
